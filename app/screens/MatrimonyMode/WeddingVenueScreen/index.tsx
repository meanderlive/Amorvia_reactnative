...
const data = [
  {img: require('../../../../assets/images/Venue/img1.png')},
  {img: require('../../../../assets/images/Venue/img2.png')},
  {img: require('../../../../assets/images/Venue/img3.png')},
];
const WeddingVenueScreen = () => {
  const navigation =
    useNavigation<NativeStackNavigationProp<MatProfileStackParams>>();
  return (
    <MainLayout onBack={navigation.goBack} title="Wedding Venues">
            ...
            return (
              <View style={styles.container}>
                <TouchableOpacity style={styles.row}>
                  ...
                  <View style={{gap: 7}}>
                    <RegularText>Venerates Massa Country</RegularText>
                    <View
                      style={{
                        flexDirection: 'row',
                        gap: 2,
                    ...
                    <SmallText>125 to 1800 Guests</SmallText>
