...
const PaymentVerifyOtpScreen = () => {
  ...
  return (
    <MainLayout onBack={navigation.goBack} title="Enter PIN">
      <>
        <ScrollView>
          <OtpInputs
            style={{
        ...
        <View style={{marginBottom: 20}}>
          <PrimaryBtn
            ...
            onPress={() => navigation.navigate('CancelPlan')}
            text={'Submit'}
            loading={loading}
...
export default PaymentVerifyOtpScreen;
